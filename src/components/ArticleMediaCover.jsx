...
export default function ArticleMediaCover({
  ...
  const effectiveCrop = cropStyle || article?.coverCropStyle || (media.isVideo ? article?.coverVideoCrop : article?.coverImageCrop) || {};
  ...
  // 2. Static Image Cover (with resilient error recovery)
